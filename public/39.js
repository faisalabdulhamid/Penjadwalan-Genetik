		...
		simpan: function simpan() {
			...
			if (this.$route.meta.edit) {
				self.$http.put(__WEBPACK_IMPORTED_MODULE_0__config_env__["c" /* base_url */] + '/' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* url */] + '/' + self.id, this.data).then(function (res) {
					self.$router.push({ name: 'hari-index' });
				});
			} else {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4b7830bb", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\admin\\components\\hari\\form.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4b7830bb", Component.options)
  } else {
    hotAPI.reload("data-v-4b7830bb", Component.options)
  }
