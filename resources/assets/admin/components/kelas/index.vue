<template>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<router-link :to="{name: 'kelas-tambah'}" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i></router-link>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr v-for="item in table.data">
							<td>{{ item.kelas}}</td>
							<td class="actions">
								<router-link :to="{name: 'kelas-ubah', params:{id:item.id}}" class="btn btn-sm btn-default"><i class="fa fa-pencil"></i></router-link>
